...
const colorRangeCache = new WeakMap();
/**
 ...
 */
export function getColorRange(colorMap) {
 ...
 */
export function getColorFromColorMapAt(colorMap, value) {
 ...
 * empty array.
 */
export function getColorMapBins(colorMap) {
    if (!colorMap.discrete || !colorMap.bins) {
        return [];
    }
 ...
 */
export function getColorInterpolator(interpolationMethods) {
